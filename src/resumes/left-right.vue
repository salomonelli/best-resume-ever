  ...
  <div class="resume" id="resume1">
    ...
    <div class="left half">
      <div class="experience">
        ...
        <div class="experience-block" v-for="(experience, index) in person.experience" :key="index">
    ...
    <div class="right half">
      <div class="education">
        ...
        <div class="education-block" v-for="(education, index) in person.education" :key="index">
      ...
      <div class="skills">
        <div class="skill-block" v-for="(skill, index) in person.skills" :key="index">
